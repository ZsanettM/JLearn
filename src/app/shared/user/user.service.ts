...
export class UserService {
  ...
  registerUser(uname: string, psw: string, email: string, avatar: string): Observable<any> {
    return this.http.post('//localhost:8080/save', JSON.stringify({username: uname, password: psw, email: email, avatar: avatar}), this.httpOptions);
  }
